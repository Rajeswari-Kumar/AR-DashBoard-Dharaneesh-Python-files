...
public class SimpleDashboard : MonoBehaviour
{
    ...
    void InitializeUI()
    {
        // Set slider range for growth rate (0% to 30%)
    ...
    void UpdateKPIDisplay()
    {
        ...
        // Update the main dashboard info display
        ...
        // Keep the old kpiText for backward compatibility
        kpiText.text = $"Total Sales: ₹{currentData.kpis.total_sales:N0}";
        
        // Update growth rate slider
    ...
    void UpdateGrowthRateSlider()
    {
        ...
        {
            // Extract numeric value from "15.2%" format
